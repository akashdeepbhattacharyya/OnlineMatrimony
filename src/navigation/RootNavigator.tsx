...
const OtpValidationScreen = lazy(() => import('../screens/otpValidation/OtpValidationScreen'));
const Onboarding = lazy(() => import('../screens/onBoarding/Onboarding'));
const ProfileSelection = lazy(() => import('../screens/profileSelection/ProfileSelection'));
const SettingsScreen = lazy(() => import('../screens/settings/Settings'));
const SearchScreen = lazy(() => import('../screens/search/SearchScreen'));
const PartnerPreferenceScreen = lazy(() => import('../screens/partnerPreference/PartnerPreferenceScreen'));
const NotificationSettingsScreen = lazy(() => import('../screens/notificationSettings/NotificationSettingsScreen'));
const AccountSettingsScreen = lazy(() => import('../screens/accountSettings/AccountSettingsScreen'));
const ContactFiltersScreen = lazy(() => import('../screens/contactFilters/ContactFiltersScreen'));
const HideDeleteProfileScreen = lazy(() => import('../screens/hideDeleteProfile/HideDeleteProfileScreen'));
...
const RootNavigator = ({ currentRoute }: RootNavigatorProps) => {
  ...
  const tabItems: { key: string; label: string; icon: string; route: string }[] = [
        ...
        >
          {user ? (
            <>
              ...
              <Stack.Screen name="HideDeleteProfile" component={HideDeleteProfileScreen} />
